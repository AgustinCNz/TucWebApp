// src/pages/dashboard/MisLandings.jsx
// -----------------------------------------------------------------------------
// Variante de listado con opciones Editar y Eliminar (parece duplicar Landing).
// -----------------------------------------------------------------------------
...
export default function MisLandings () {
  ...
  const handleEliminar = async id => {
    if (!window.confirm('¿Estás seguro que deseas eliminar esta landing?')) return
    try {
  ...
  /* Editar → redirige */
  const handleEditar = landingId => navigate(`/dashboard/landing/editar/${landingId}`)
...
/* Sugerencias
1. Consolidar este componente y Landing.jsx para evitar duplicación.
2. Mover confirm/alert a un modal personalizado.
*/
